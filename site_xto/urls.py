...
urlpatterns = [
    ...
    path('cluster/<cluster>/download', cluster_view_download, name="cluster_view_download"),
    ...
    path('cluster_view/enrichment/<matrix_name>/download', lncrnas_cluster_enrichment_download_view, name="lncrnas_cluster_enrichment_download_view"),
